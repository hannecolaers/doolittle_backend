...
class MembershipTestCase(TestCase):
    def setUp(self):
        ...
        self.url_absolute_with_id = 'http://testserver/memberships/' + str(self.membership.id) + '/'
    ...
    def test_get_membership_returns_200_when_found(self):
        """
        A GET request on /memberships/<id>/ should return a squad
        """
    ...
    def test_get_membership_returns_404_when_not_found(self):
        """
        A GET request on /memberships/<id>/ should return a 404 error when the squad doesn't exist
        """
    ...
    def test_post_membership_returns_405(self):
        """
        A POST request on /memberships/<id>/ should not be possible
        """
    ...
    def test_put_membership_returns_200_when_updated(self):
        """
        A PUT request on /memberships/<id>/ should return an updated squad
        """
    ...
    def test_put_membership_returns_404_when_not_found(self):
        """
        A PUT request on /memberships/<id>/ should return a 404 when using an invalid id
        """
    ...
    def test_delete_membership_returns_204_when_deleting(self):
        """
        A DELETE request on /memberships/<id>/ should delete a squad
        """
        response = self.client.delete(self.url_with_id)
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
    ...
    def test_delete_membership_returns_404_when_not_found(self):
        """
        A DELETE request on /memberships/<id>/ should return 404 when deleting unexisting squad
        """
        url = reverse('employee-detail', args=[999])
        response = self.client.delete(url)
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
    ...
    def test_patch_membership_returns_200_when_updated(self):
        """
        A PATCH request on /memberships/<id>/ should return an updated squad
        """
    ...
    def test_patch_membership_returns_404_when_not_found(self):
        """
        A PATCH request on /memberships/<id>/ should return 404 when not found
        """
        url = reverse('membership-detail', args=[999])
    ...
    """
    Tests for the /memberships/ path
    """
    ...
    def test_put_all_membership_returns_405(self):
        """
        A PUT request on /memberships/ should not be possible
        """
        url = reverse('membership-list')
        response = self.client.put(url, self.membership_json, format="json")
        self.assertEqual(response.status_code, status.HTTP_405_METHOD_NOT_ALLOWED)
    ...
    def test_patch_all_membership_returns_405(self):
        """
        A PATCH request on /memberships/ should not be possible
        """
        url = reverse('membership-list')
        response = self.client.patch(url, self.membership_json, format="json")
        self.assertEqual(response.status_code, status.HTTP_405_METHOD_NOT_ALLOWED)
    ...
    def test_delete_all_membership_returns_405(self):
        """
        A DELETE request on /memberships/ should not be possible
        """
        url = reverse('membership-list')
        response = self.client.delete(url)
        self.assertEqual(response.status_code, status.HTTP_405_METHOD_NOT_ALLOWED)   
...
'''     def test_post_all_membership_returns_201_when_correct_format(self):
        """
        A POST request on /memberships/ should create a new squad
        """
        response = self.client.post('/memberships/', self.membership_json, format="json")
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertIn("id", response.data)

    def test_post_all_membership_returns_400_when_bad_format(self):
        """
        A POST request on /memberships/ using the wrong format should return a 400 error
        """
        data = {'title': 'Squad'}
        response = self.client.post('/memberships/', data, format='json')
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST) '''